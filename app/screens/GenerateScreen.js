      ...
      if (Platform.OS === 'android' && isSubscribed) {
        ...
        ReactNativeBlobUtil.config({
          ...
          addAndroidDownloads: {
            ...
            description: 'Downloading image from Wrap my Cars',
            mime: 'image/jpeg',
            mediaScannable: true,
          },
        })
          ...
          try {
            ...
            if (ReactNativeBlobUtil.android?.addCompleteDownload) {
              await ReactNativeBlobUtil.android.addCompleteDownload({
                title: filename,
                description: 'Car modification generated by Wrap my Cars',
                mime: 'image/jpeg',
                path: destPath,
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      await RNShare.open({
        ...
        message: 'Check out my AI-generated car wrap! Created with Wrap my Cars',
        type: 'image/jpeg',
      });
    } catch (error) {
